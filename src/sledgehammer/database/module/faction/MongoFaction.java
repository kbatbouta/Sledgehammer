...
public class MongoFaction extends MongoDocument {
	 ...
	 * 
	 * @param collection
	 *            The <MongoCollection> storing the faction.
	 * @param object
	 *            The <DBObject> storing the faction data.
	 */
	 ...
	 * 
	 * @param collection
	 *            The <MongoCollection> associated with storing factions.
	 * @param name
	 *            The name of the faction.
	 * @param tag
	 *            The tag for faction members.
	 * @param color
	 *            The color of the faction. (The un-rastered form. a.k.a: light_blue
	 * @param ownerId
	 *            The <UUID> of the Player owning the faction.
	 * @param password
