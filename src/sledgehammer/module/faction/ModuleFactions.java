...
public class ModuleFactions extends MongoModule {
	 ...
	 * @param ownerId
	 *            The <UUID> of the Player that is set to as the owner of the
	 *            <Faction>
	...
	/**
	 * Removes a <Faction> from the database, and removes <FactionMember>'s from the
	 * <Faction>.
	 * 
	 * @param faction
	 *            The <Faction> being deleted.
	 * @return true
	 */
	 ...
	 * 
	 * @param factionMember
	 *            The <FactionMember> being processed.
	 */
	 ...
	 * 
	 * @param player
	 *            The <Player> being given a representing <FactionMember> container.
	 * @param faction
	 *            The <Faction> the result <FactionMember> is being assigned to.
	 ...
	 * 
	 * @param playerId
	 *            The <UUID> representing the <FactionMember> container.
	 * @param faction
	 *            The <Faction> the result <FactionMember> is being assigned to.
	 * @return A <FactionMember> container for the given <Player>.
	 */
	...
	/**
	 * @param playerId
	 *            The <UUID> ID of the <Player>.
	 * @return Returns a <FactionMember> with a given <UUID> playerId. Returns null
	 ...
	 * @return Returns the <Faction> representing the <UUID> given. If there is
	 ...
	 * 
	 * @param player
	 *            The <Player> being invited to the <Faction>.
	 * @param faction
	 *            The <Faction> inviting the <Player>.
	 ...
	 * 
	 * @param factionInvite
	 *            The <FactionInvite> being deleted & removed.
	 */
	 ...
	 * 
	 * @param faction
	 *            The <Faction> the <ChatChannel> is for.
	 * @return A <ChatChannel> for the given <FactioN>
	 */
...
//		return chatChannel;
	 ...
	 * 
	 * @param faction
	 *            The <Faction> that the <ChatChannel> being unregistered is being
	 *            removed.
	 ...
	 * 
	 * @param factionOwner
	 *            The <Faction> being invited to.
	 * @param playerIdOwner
	 *            The <UUID> of the <Player> inviting.
	 * @param playerIdInvited
	 *            The <UUID> of the <Player> invited.
	 */
