 ...
 * registered <Module>'s in the Sledgehammer engine.
 * 
 * @author Jab
 */
public class RequestChannelsEvent extends PlayerEvent {
	 ...
	 * 
	 * @param player
	 *            The <Player> requesting <ChatChannel>'s.
	 */
	...
	/**
	 * @return Returns the <List> of <ChatChannel>'s to send to the <Player>.
	 */
