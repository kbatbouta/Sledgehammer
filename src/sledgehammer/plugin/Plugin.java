...
public class Plugin extends Printable {
	 ...
	 *            The <File> Object of the Jar File containing the plug-in.
	 * @param properties
	 *            The plug-in properties to set manually.
	 */
	...
	/**
	 * Constructs the Java Object instances of the <Module>'s assigned to the
	 * plug-in.
	 */
	 ...
	 * 
	 * @param moduleName
	 *            The <String> name of the <Module> to load.
	...
	/**
	 * Processes 'onLoad()' for the plug-in's <Module>'s.
	 */
	...
	/**
	 * Updates the plug-in's <Module>'s.
	 * 
	 * @param delta
	...
	/**
	 * Unloads the plug-in's <Module>'s.
	 */
	 ...
	 * @param delta
	 *            The time in milliseconds since the last update tick.
	 ...
	 * 
	 * @param module
	 *            The <Module> to add to the plug-in.
	 */
	 ...
	 * @return Returns true if the <Module> is in the plug-in and is removed.
	 */
	...
	/**
	 * @return Returns a <Collection> of the <Module>'s registered and loaded in the
	 *         plug-in.
	 */
	 ...
	 * 
	 * @param jarPath
	 *            The <String> path in the Jar File.
	 * @param destPath
	 ...
	 *            The <String> path in the Jar File.
	 * @param dest
	 *            The <File> destination to save to.
	 */
	...
	/**
	 * @return Returns a <List> of the loaded <Module>'s in the plug-in.
	 */
	...
	/**
	 * @return Returns a <List> of started <Module>'s in the plug-in.
	 */
	 ...
	 * @param source
	 *            The <String> source path of the <File> to stream.
	 ...
	 *            The <File> Object of the Jar File.
	 * @param source
	 *            The <String> source path to the File entry in the Jar File.
	 * @param destination
	 *            The <File> destination to write the stream to.
	 */
