...
/**
 * Class to handle <NPC>'s with a passive, long-term behavior pattern. This
 * class provides utilities and executes <Action>'s for the <NPC> to act on.
 * 
 * @author Jab
 */
public abstract class Behavior extends Printable {
	...
	/**
	 * Updates the <NPC>'s <Behavior> if it is active.
	 */
	...
	/**
	 * @param radius
	 *            The <Integer> radius in <IsoGridSquare>'s around the <NPC>.
	 * @return Returns a <List> of <IsoWorldInventoryObject>'s around the <NPC> on
	 *         the ground.
	 */
	 ...
	 * 
	 * @param target
	 *            The <IsoMovingObject> target to set.
	 */
	...
	/**
	 * @return Returns the <Float> weight value of the <NPC>'s inventory.
	 */
	...
	/**
	 * @return Returns the <Float> x-coordinate of the <NPC>'s location.
	 */
	public float getX() {
		return getNPC().getX();
	}
	...
	/**
	 * Sets the <Float> x-coordinate of the <NPC>'s location.
	 * 
	 * @param x
	 *            The <Float> coordinate to set.
	 */
	...
	/**
	 * @return Returns the <Float> y-coordinate of the <NPC>'s location.
	 */
	public float getY() {
		return getNPC().getY();
	}
	...
	/**
	 * Sets the <Float> y-coordinate of the <NPC>'s location.
	 * 
	 * @param y
	 *            The <Float> coordinate to set.
	 */
	...
	/**
	 * @return Returns the <Float> z-coordinate of the <NPC>'s location.
	 */
	public float getZ() {
		return getNPC().getZ();
	}
	...
	/**
	 * Sets the <Float> z-coordinate of the <NPC>'s location.
	 * 
	 * @param z
	 *            The <Float> coordinate to set.
	 */
	 ...
	 * 
	 * @param x
	 *            The <Float> x-coordinate of the location.
	 * @param y
	 *            The <Float> y-coordinate of the location.
	 * @param z
	 *            The <Float> z-coordinate of the location.
	 */
	 ...
	 * 
	 * @param o
	 *            The <IsoObject> to set as the location.
	 */
	 ...
	 *            The <IsoWorldInventoryObject> to set.
	 */
	...
	/**
	 * @param listZombies
	 *            The <List> of <IsoZombie>'s to test.
	 ...
	 * 
	 * @param target
	 *            The <IsoGameCharacter> target to set.
	 */
