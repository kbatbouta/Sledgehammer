...
public class KahluaTableImpl implements KahluaTable {
   ...
   public void rawset(Object key, Object value) {
      ...
      Object lastVal = null;
      if(Core.bDebug && LuaManager.thread != null && LuaManager.thread.hasDataBreakpoint(this, key)) {
         lastVal = this.rawget(key);
      }

      if(value == null) {
         if(Core.bDebug && LuaManager.thread != null && LuaManager.thread.hasDataBreakpoint(this, key) && lastVal != null) {
            UIManager.debugBreakpoint(LuaManager.thread.currentfile, (long)LuaManager.thread.lastLine);
         }

         this.delegate.remove(key);
      } else {
         if(Core.bDebug && LuaManager.thread != null && LuaManager.thread.hasDataBreakpoint(this, key) && !value.equals(lastVal)) {
            int a = GlobalObject.getCurrentCoroutine().currentCallFrame().pc;
            if(a < 0) {
               a = 0;
            }

            UIManager.debugBreakpoint(LuaManager.thread.currentfile, (long)(GlobalObject.getCurrentCoroutine().currentCallFrame().closure.prototype.lines[a] - 1));
         }
   ...
   public Object rawget(Object key) {
      if(this.reloadReplace != null) {
         ...
         if(Core.bDebug && LuaManager.thread != null && LuaManager.thread.hasReadDataBreakpoint(this, key)) {
            int a = GlobalObject.getCurrentCoroutine().currentCallFrame().pc;
            if(a < 0) {
               a = 0;
            }
   ...
   public void setRewriteTable(Object value) {
      for(KahluaTableImpl toChange = this; toChange != null; toChange = toChange.getRewriteTable()) {
         ;
      }
   ...
   private static byte getValueByte(Object o) {
      return (byte)(o instanceof String?0:(o instanceof Double?1:(o instanceof Boolean?3:(o instanceof KahluaTableImpl?2:-1))));
   }
