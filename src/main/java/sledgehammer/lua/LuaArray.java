...
/**
 * A very convenient LuaObject that stores elements as an ArrayList, allowing exporting into proper
 * KahluaTables without any boilerplate code.
 *
...
public class LuaArray<T> extends LuaObject {
   ...
   * @return Returns the element located at the index of the Array. If nothing is defined at this
