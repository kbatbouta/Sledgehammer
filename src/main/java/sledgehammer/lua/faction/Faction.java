...
public class Faction extends MongoLuaObject<MongoFaction> {
   ...
   * @return Returns true if the FactionMember is successfully added to the Faction.
   */
   ...
   * @return Returns whether or not the provided String password matches the encrypted password.
   */
  ...
  /**
   * Returns whether or not the String tag given is the same tag as the one the Faction uses.
   *
   * @param tag The String tag being tested.
   * @return Returns true if the tag is the same as the tag being used by the Faction.
   */
   ...
   * @return Returns true if the FactionMember's Unique ID for the Player matches the ownerId of the
   *     Faction.
   */
