...
public class SendLua extends Send {
   ...
   *
   * <p>(Note: This does not append. To append, use <code>appendLuaFile(files);</code>)
   *
  ...
  /**
   * @return Returns the Player Object set to pass and reference when building Lua Strings. (Note:
   *     This is optional, and null can be returned. Make sure to set null checks)
   */
   ...
   *
   * <p>(Note: If 'SendLua.debugLua' is set to true, lines will be preserved)
   *
