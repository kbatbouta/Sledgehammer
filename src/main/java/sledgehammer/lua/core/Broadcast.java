 ...
 *   - "player_id": (String) The UUID-String of the player who sent the Broadcast.
 *                  (Note: If the player_id is not set, it should be handled as
 *                   administrator)
...
public class Broadcast extends LuaTable {
	 ...
	 * 
	 * @param message
	 *            The <String> message content of the Broadcast.
	 */
	...
	/**
	 * @return Returns the <UUID> of the <Player> who sent the Broadcast.
	 * 
	 *         (Note: if the UUID is not set, then it should be handled as
	 *         administrator)
	 */
	...
	/**
	 * Sets the <UUID> of the <Player> who sent the Broadcast.
	 * 
	 * (Note: if the UUID is not set, then it should be handled as administrator)
	 * 
	 * @param playerId
	 *            The <UUID> of the <Player> to set.
	 */
