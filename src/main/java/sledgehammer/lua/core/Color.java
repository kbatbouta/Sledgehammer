...
/**
 * LuaTable that handles the storage of color data, and color utilities for the
 * Sledgehammer engine.
 *
 * @author Jab
 */
public class Color extends LuaTable implements Comparable<Color> {
	 ...
	 * 
	 * @param r
	 *            The <Float> red value, between 0 and 1.
	 * @param g
	 *            The <Float> green value, between 0 and 1.
	 * @param b
	 *            The <Float> blue value, between 0 and 1.
	 */
	 ...
	 *            The <Float> blue value, between 0 and 1.
	 * @param a
	 *            The <Float> alpha value, between 0 and 1.
	 */
	...
	/**
	 * KahLua load constructor.
	 * 
	 * @param table
	 *            The <KahluaTable> storing the <Color> data.
	 */
	...
	/**
	 * Empty Constructor. The default color is Black, being that red will be 0,
	 * green will be 0, blue will be 0, and alpha will be 1.
	 */
	public Color() {
		super("Color");
	}
	...
	/**
	 * Returns 0 if the other color matches. Returns 1 if not matching. Returns 2 if
	 * the colors match, however the alpha do not.
	 * 
	 * @param other
	 *            The <Color> to compare.
	 * @return Returns the standard <Integer> result from <Comparator>'s.
	 */
	@Override
	 ...
	 * 
	 * @param value
	 *            The <Float> value to limit. If the value is lower than 0, 0 will
	 ...
	 * 
	 * @param value
	 *            The <Float> value to limit. If the value is lower than the <Float>
	 ...
	 *            returned.
	 * @param minimum
	 *            The <Float> minimum value for the returned Float value to be
	 *            returned.
	 * @param maximum
	 *            The <Float> maximum value for the returned Float value to be
	 *            returned.
