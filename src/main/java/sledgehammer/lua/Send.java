...
/**
 * LuaTable sub-class to identify the String Client ID of the Module being interfaced and the String
 * command to identify the sub-routine to interface.
 *
 * @author Jab
 */
public abstract class Send extends LuaTable {
  ...
  /** @return Returns the String command to identify the sub-routine to interface. */
