...
public abstract class PermissionObject<M extends MongoUniqueNodeDocument> extends MongoLuaObject<M> {
     ...
     * Main constructor.
     *
     * @param mongoDocument The MongoDocument to set as the MongoDB Document for the
     *                      PermissionObject.
     ...
     * @return Returns a List of Nodes that are sub-nodes of the String
     * super-node given.
     */
     ...
     * @return Returns true if any of the Nodes in the List given are flagged
     * true.
     */
    ...
    /**
     * @param nodes The List of Nodes being tested.
     * @return Returns a List of Nodes that are granted. If none in the List
