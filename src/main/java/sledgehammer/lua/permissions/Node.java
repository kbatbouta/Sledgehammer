...
/**
 * LuaTable designed to handle Node data and operations for the Permissions Module.
 *
 * @author Jab
 */
public class Node extends LuaTable {
   ...
   * Lua constructor.
   *
   * <p>(Note: The MongoDocumentEntry created from this constructor will not be assigned to a
   * MongoDocumentEntry, and cannot be implicitly saved)
   *
  ...
  public void onLoad(KahluaTable table) {
    ...
    if (oNode == null) {
      throw new IllegalArgumentException(
          "The KahluaTable is invalid for a node. (Field 'name' is null)");
    }
   ...
   *
   * <p>1) ("sledgehammer.node.example") this node will automatically be set to true for the flag.
   *
   * <p>2) ("sledgehammer.node.example:1) this node will be set to true.
   *
   * <p>3) ("sledgehammer.node.example:true) this also works. (false, and other entries will be set
   * as false)
   *
