 ...
 *
 * <p>TODO: Change String Color to Color object.
 *
 * <p>TODO: Implement PeriodicMessage on the Lua-end of Sledgehammer's ModuleChat.
 *
 * @author Jab
 */
public class PeriodicMessage extends LuaTable {
   ...
   * Main constructor.
   *
   * @param name The String identifier of the PeriodicMessage.
   * @param content The String content of the PeriodicMessage.
   */
  ...
  /** @return Returns the String name associated with this message. (the ID of the message) */
