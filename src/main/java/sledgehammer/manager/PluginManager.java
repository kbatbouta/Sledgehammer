...
public class PluginManager extends Manager {
   ...
   * (Private Method)
   *
   * <p>Loads the Core Plug-in with all the Modules for the core.
   */
   ...
   * (Private Method)
   *
   * <p>Loads Plug-ins installed in the plugin directory.
   */
  ...
  /**
   * Passes a ClientEvent to the Module identifying with the Client ID given, and handles the
   * ClientEvent.
   *
  ...
  /** @return Returns the File Object for the directory that Plug-in's are installed. */
