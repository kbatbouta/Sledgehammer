 ...
 *
 * <p>This class is used to initialize all components of SledgeHammer, and act as a approximation to
 * access most components in SledgeHammer.
 *
 * <p>TODO: Fix documentation.
 *
 * @author Jab
 */
public class SledgeHammer extends Printable {
  ...
  /**
   * UdpEngine pointer for the Project Zomboid GameServer UdpEngine instance, to communicate with
   * connections.
   */
  ...
  /**
   * Boolean to load SledgeHammer for testing a module, without ProjectZomboid code being invoked
   * directly. Used for Module test classes.
   */
   ...
   * @return Returns true if the Player is granted the given String permission-node.
   */
  ...
  /**
   * Adds a String permission-node to the default PermissionGroup, allowing all Players to be
  ...
  /**
   * Adds a String permission-node to the default PermissionGroup with a given Boolean flag. All
  ...
  /**
   * Returns a Player with a given nickname or user-name, or a fragment of that name. User-names are
   * checked before Nicknames are checked.
   *
   * @param nameFragment The String name or fragment of the of the user-name or nickname of the
   *     Player.
   * @return Returns a Player. If a Player is not identified with the given String fragment, null is
   *     returned.
   */
  ...
  public void send(Send send, Player player) {
    ...
    if (!isReloading() && player.isConnected()) {
      ...
      GameServer.sendServerCommand(
          "sledgehammer.module." + send.getModule(),
          send.getCommand(),
          send.export(),
   ...
   * @return Returns a Player with a given String nickname. If no online Players have this nickname,
   ...
   * @return Returns a Player with a given String user-name. If no online Players have this
   *     nickname, then null is returned.
   */
   ...
   * @return Returns a Player object if the player exists in the database. Returns null if the
  ...
  /** @return Returns the cache folder for SledgeHammer data, settings, and plug-ins. */
  ...
  /** @return Returns whether or not the SledgeHammer framework has started operations. */
   ...
   *
   * <p>This method is a simplified version of: <code> handleEvent(event, true); </code>,
   *
   * <p>The Event is logged.
   *
  ...
  /**
   * Handles a given CommandEvent, by giving the UdpConnection associated with the raw input String.
   * Logging is optional.
   *
  ...
  /**
   * Passes a Command to be handled by registered CommandListeners with the Command's.
   *
   ...
   * @return Returns the native IsoPlayer Object with the name of the Player.
   */
   ...
   * @return Returns the native IsoPlayer Object with the String user-name of the Player.
   */
   ...
   * @return Returns the native IsoPlayer with a given user-name-fragment. If no Player's user-name
   *     contains the fragment, null is returned.
   */
  ...
  /**
   * @param nickname The nickname of the Player.
   * @return Returns the native IsoPlayer Object for a Player with the given nickname. If no Player
   *     has this nickname, null is returned.
   */
   ...
   * @return Returns the native IsoPlayer Object for a Player with the String nickname-fragment. If
   *     no Player's nickname contains the fragment, null is returned. returned.
   */
  ...
  public void sendServerCommand(
      Player player, String module, String command, KahluaTable kahluaTable) {
  ...
  /**
   * @param username The user-name of the Player.
   * @return Returns a Player with the given user-name. If a Player does not have this user-name,
   *     null is returned.
   */
   ...
   * @return Returns a Player with the given Unique ID. If no Player has this uniqueId, null is
   *     returned.
   */
  ...
  public static String getJarFileLocation() {
    ...
    try {
      ...
      path =
          SledgeHammer.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
