...
public class LanguagePackage {
  ...
  /** The Map of Sledgehammer Color constants, assigned to hexadecimal characters. */
  ...
  public static void main(String[] args) {
    ...
    fields = new EntryField[] {new EntryField("Name1", "John"), new EntryField("naMe2", "Bob")};
    ...
    fields =
        new EntryField[] {new EntryField("start", "Starting"), new EntryField("end", "Ending.")};
