 ...
 * and defined anywhere within the String to be injected with EntryFields.
...
public class LanguagePackage {
     ...
     * LanguageFiles as "{{name}}_{{language_abbreviation}}.yml"
     */
    private String name;
     ...
     * Main constructor.
     *
     * @param directory The File Object for the directory where the LanguageFiles are
     *                  stored.
     * @param name      The String name of the LanguagePackage. This is noted in the
     *                  LanguageFiles as "{{name}}_{{language_abbreviation}}.yml"
     */
     ...
     * additionally defined EntryFields.
     *
     ...
     * @param entries  The EntryList Array of any additional entries to process with
     *                 the String message.
     */
     ...
     * and additionally defined EntryFields.
     *
     * @param player  The Player to send the String message.
     * @param key     The String identity of the entry to process.
     * @param entries The EntryList Array of any additional entries to process with
     ...
     * @param entries  Any additional EntryFields that add to or override the
    ...
    /**
     * @return Returns the File Object of the directory where the LanguageFiles
     * are located.
     */
     ...
     * (Private Method)
     * <p>
     * Sets the File Object of the directory where the LanguageFiles are
     * located.
     *
     ...
     * @param languagePackage The LanguagePackage library to reference for any EntryField's
     *                        not defined that are requested.
     * @param language        The Language to use primarily. If EntryField's are not
     ...
     * @param entries         The EntryField Array to add to or override the LanguagePackage
     *                        library if passed.
    ...
    public static String processString(String value, LanguagePackage languagePackage, Language language,
        ...
        for (int index = 0; index < chars.length; index++) {
            ...
            if (in) {
                ...
                if (charCurrent == '[' && charNext != null && charNext == '&' && index + 3 <= chars.length - 1) {
                    ...
                    valueProcessed.append(colorCode);
                    index += 3;
                } else if (charCurrent == '{' && charNext != null && charNext == '{') {
                    in = true;
                    index += 1;
                    key = "";
                } else {
    ...
    public static List<String> toList(String string) {
        ...
        return Arrays.asList(string.split(NEW_LINE));
    }
