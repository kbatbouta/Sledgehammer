...
public abstract class MongoDocumentElement {
  ...
  /** @return Returns whether or not the MongoDocumentEntry has an assigned MongoDocument. */
   ...
   *
   * <p>(Note: If the MongoDocumentEntry does not have an assigned MongoDocument, an
  ...
  /**
   * Loads the MongoDocumentEntry, handing the DBObject representation to the method.
   *
   * @param object The DBObject representing the MongoDocumentEntry.
   */
  public abstract void onLoad(DBObject object);

  /**
   * Stores the MongoDocumentEntry into a given DBObject that is created for this purpose.
   *
