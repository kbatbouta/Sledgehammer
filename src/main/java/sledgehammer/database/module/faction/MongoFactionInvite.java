...
public class MongoFactionInvite extends MongoDocument {
   ...
   * Loading constructor.
   *
   * @param collection The MongoCollection storing the invite.
   * @param object The DBObject storing the invite data.
   */
  ...
  public MongoFactionInvite(
      MongoCollection collection, UUID inviteeId, UUID invitedId, UUID factionId) {
    super(collection, "id");
  ...
  /** @return Returns the Long UNIX TimeStamp representing the time the Invitation was created. */
   ...
   *
   * @param timeInvited The Long UNIX TimeStamp representing the time the Invitation was created.
   */
