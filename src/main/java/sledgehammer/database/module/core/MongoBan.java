...
public class MongoBan extends MongoDocument {
   ...
   * @throws IllegalArgumentException Thrown if the Ban is set to Steam ID.
   */
   ...
   * @throws IllegalStateException Thrown if the Ban is not set to Steam ID.
   */
