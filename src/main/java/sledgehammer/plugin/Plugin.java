...
public class Plugin extends Printable {
  ...
  /** The ClassLoader for the plug-in. This is the System ClassLoader for the core plug-in. */
   ...
   * (Private Method)
   *
   * <p>Loads the plug-in's properties and definitions.
   */
  ...
  /** Constructs the Java Object instances of the Modules assigned to the plug-in. */
   ...
   * (Private Method)
   *
   * <p>Attempts to load a given Module.
   *
   ...
   * (Private Method)
   *
   * <p>Attempts to start a given Module.
   *
    ...
    for (Module moduleNext : listModulesToLoad) {
      ...
      if (classLiteral.equalsIgnoreCase(classLiteralNext)) {
        throw new IllegalArgumentException(
            "Module "
                + classLiteral
                + " is already loaded in the plug-in "
                + getPluginName()
                + ".");
      }
    }
   ...
   * @return Returns the Module with the given String name. If no Module in the plug-in has the name
   ...
   * @return Returns the Module instance of the Java Class given. If no Module loaded in the plug-in
   *     is of the Class given, null is returned.
   */
  ...
  /** @return Returns a Collection of the Modules registered and loaded in the plug-in. */
   ...
   * (Private Method)
   *
   * <p>Sets the properties and definitions of the plug-in.
   *
   ...
   * (Private Method)
   *
   * <p>Sets the File Object of the Jar File.
   *
   ...
   * (Private Method)
   *
   * <p>Sets the defined Java ClassLoader used by the plug-in.
   *
  ...
  public File getPluginDirectory() {
    if (pluginDirectory == null) {
      pluginDirectory =
          new File(SledgeHammer.instance.getPluginManager().getPluginDirectory(), getPluginName());
