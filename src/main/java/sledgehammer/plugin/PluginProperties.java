...
/**
 * LuaTable to handle the assignment and definition of plug-ins and the module definitions
 * registered with it.
 *
 * @author Jab
 */
...
public class PluginProperties extends LuaTable {
   ...
   * (Private Method)
   *
   * <p>Loads the properties from the YAML definition.
   */
   ...
   * (Private Method)
   *
   * <p>Sets the String name definition of the plug-in.
   *
   ...
   * (Private Method)
   *
   * <p>Sets the String version definition of the plug-in.
   *
   ...
   * (Private Method)
   *
   * <p>Sets the String description definition of the plug-in.
   *
  ...
  /**
   * @return Returns a List of String name definitions of all module registered in the plug-in's
   *     definitions.
   */
   ...
   * @return Returns a ModuleProperty definition of the Module with the given String name. If no
   *     Module defined in the plug-in uses the name given, null is returned.
   */
