...
public abstract class Module extends Printable {
   ...
   * (Note: Modules should not use this method)
   *
   * <p>Updates the Module every tick.
   *
  ...
  /**
   * Registers a ChatChannel with a name, description, and permission-node to access it. Throws an
   * IllegalArgumentException if the name provided is null or empty.
   *
   * <p>The ChatChannel is set to be global, public, not custom, saves history, and allows Players
   * to speak.
   *
   * @param name The String name of the ChatChannel.
  ...
  public ChatChannel createChatChannel(String name, String description, String permissionNode) {
    ...
    return createChatChannel(name, description, permissionNode, true, true, false, true, true);
  }

  /**
   * Registers a ChatChannel with a name, description, permission-node, and all flags associated
   * with it.
   *
   * @param channelName The String name of the ChatChannel.
   * @param channelDescription The String description of the ChatChannel.
   * @param permissionNode The String permission-node of the ChatChannel.
   * @param isGlobalChannel Flag for if the ChatChannel should send messages to all players, or
   *     players relative to their location.
   * @param isPublicChannel Flag for if the ChatChannel is public to all Players, or if the
   *     ChatChannel is only accessible to the Player's with the given permission-node.
   ...
   * @param canSpeak Flag for if the Players are allowed to send Messages in the ChatChannel.
   *     (Read-Only if set to false)
   * @return Returns the result ChatChannel.
   */
  public ChatChannel createChatChannel(
    ...
    return moduleChat.createChatChannel(
        channelName,
        channelDescription,
        permissionNode,
        isGlobalChannel,
  ...
  /**
   * @return Returns true if the Settings allow Lua files to be modified by anything other than the
   *     Modules that saves the Lua Files. Returns false if ONLY the Modules have rights to the
   *     final versions of Lua files.
   */
  ...
  /**
   * Saves a File resource stored in the Plug-in Jar File to the same location inside the Module's
   * data folder. If the File exists in that location, the File is not overwritten.
   *
  ...
  /**
   * Saves a File resource stored in the Plug-in Jar File to the same location inside the Module's
   * data folder. If the file exists in that location and overwrite is set to false, the File is not
   * overwritten.
   *
   * @param path The String path to the File inside the Jar File.
   * @param overwrite Flag to set if the File is to be overwritten, regardless of it's state.
   */
  ...
  /**
   * Saves a File resource stored in the Plug-in Jar file to the given destination inside the
   * Module's data folder. If the file exists in the destination, the File is not overwritten.
   *
   * @param jarPath The String path to the File inside the Jar File.
   * @param destPath The String destination path to the File stored inside the Module's data folder.
   */
  ...
  /**
   * Saves a File resource stored in the Plug-in Jar file to the given destination inside the
   * Module's data folder. If the file exists in that location and overwrite is set to false, the
  ...
  /**
   * Saves a File resource stored in the Plug-in Jar file to the absolute File path provided.. If
   * the File exists in the location given and overwrite is set to false, the File will not be
   * saved.
   *
   * @param jarPath The String path to the File inside the Jar File.
   * @param absolutePath The absolute File location to save the file. (This is not a directory, but
   *     a full file path)
   * @param overwrite Flag to set if the File is to be overwritten, regardless of it's state.
   */
  ...
  /**
   * Sets the Sledgehammer engine's PermissionListener. This method is reserved for the Plug-ins
   * implementing a permissions solution.
   *
   ...
   *
   * <p>Adds a String permission-node to the default PermissionGroup, allowing all Players to be
   * granted the permission-node.
   *
   ...
   * Approximate Method to 'SledgeHammer.instance.addDefaultPermission(node)'.
   *
   * <p>Adds a String permission-node to the default PermissionGroup with a given Boolean flag. All
   * PermissionUsers with a specific definition will override this.
   *
   * @param node The String node to add.
   ...
   *
   * <p>Handles a Event, passing it to all registered EventListeners listening for the Event's type.
   *
   * @param event The Event to handle.
   * @param shouldLog Flag for whether or not to pass the Event to the registered LogListeners as a
   *     LogEvent, based on the data set in the Event.
   */
  ...
  /** @return Returns the String name of the Project Zomboid server displayed in public. */
  public String getPublicServerName() {
    return SledgeHammer.instance.getPublicServerName();
  }

  /** @return Returns the chat Module from the Core plug-in of Sledgehammer. */
   ...
   * (Note: Modules should not use this method)
   *
   * <p>Sets the Plug-in that the Module is assigned to.
   *
  ...
  /** @return Returns the String version of the Module, as defined in the Module's properties. */
   ...
   * (Note: Modules should not use this method)
   *
   * <p>Sets the Module's properties and definitions for integration into the Sledgehammer engine.
   *
  ...
  /**
   * @return Returns the String identity of the Module for Lua-Client identification for ClientEvent
   *     communication.
   */
  ...
  /**
   * @param name The String name of the ChatChannel.
   * @return Returns a ChatChannel with the given String name. If no ChatChannel uses the name, null
   *     is returned.
   */
  ...
  /**
   * @return Return's the Module's String name defined in the properties. This is used for
  ...
  public File getLuaDirectory() {
    File dir =
        new File(
            SledgeHammer.instance.getLuaDirectory(),
            "Module" + File.separator + getClientModuleId());
   ...
   *
   * @param listDefaultPermissions The list of permission nodes to add.
   */
   ...
   *
   * <p>(Override this method if you want to execute code in your module when it loads)
   */
  public void onLoad() {}
   ...
   *
   * <p>(Override this method if you want to execute code in your module when it starts)
   */
  public void onStart() {}
   ...
   *
   * <p>(Override this method if you want to execute code in your module when the server updates)
   *
   ...
   *
   * <p>(Override this method if you want to execute code in your module when it stops)
   */
  public void onStop() {}
   ...
   *
   * <p>(Override this method if you want to execute code in your module when it unloads)
   */
  ...
  /**
   * Used to execute GenericEvent commands. This will be picked up by module that @override this
   * this method.
   *
   ...
   *
   * <p>This allows each Module to choose what to send to the Player. This means that while regular
   * Players receive code for most functions, advanced Players may get more code to do more things.
   *
   * @param send The lua send object to append any lua files to.
   */
