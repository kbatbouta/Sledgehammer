...
public class INI {
    ...
    while (scanner.hasNextLine()) {
      ...
      if (newLine.startsWith("[") && newLine.endsWith("]")) {
        ...
        if (mapSection != null) {
          ...
          if (mapSectionAsString == null) mapSectionAsString = new HashMapINI<>(mapSectionName);
        } else {
  ...
  public void setVariable(
      String sectionName, String variableName, Object variable, String... comments) {
  ...
  public void setVariable(
      String sectionName, String variableName, Object variable, List<String> comments) {
  ...
  public HashMapINI<String, Object> createSection(String sectionName, List<String> comments) {
    ...
    if (mapSectionVariableComments.get(sectionName) == null) {
      mapSectionVariableComments.put(
          sectionName, new HashMapINI<String, List<String>>(sectionName));
    }
    return map;
  }
