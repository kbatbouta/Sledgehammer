...
/**
 * This class implements the xorshift128+ algorithm that is a very fast, top-quality 64-bit
 * pseudo-random number generator. The quality of this P.R.N.G. is much higher than {@link
 * Random}'s, and its cycle length is 2<sup>128</sup>&nbsp;&minus;&nbsp;1, which is more than enough
 * for any single-thread application. More details and algorithms can be found <a
 * href="http://xorshift.di.unimi.it/">here</a>.
 *
 * <p>Instances of RandomXS128 are not thread-safe.
 *
 * @author Inferno
 * @author davebaol
 */
public class RandomXS128 extends Random {
  ...
  private static final long serialVersionUID = 1437419869953644563L;
   ...
   *
   * <p>This implementation creates a {@link Random} instance to generate the initial seed.
   */
  public RandomXS128() {
  ...
  /**
   * Returns the next pseudo-random, uniformly distributed {@code long} value from this random
   * number generator's sequence.
   *
   * <p>Subclasses should override this, as this is used by all other methods.
   */
  @Override
  ...
  /**
   * This protected method is final because, contrary to the superclass, it's not used anymore by
   * the other methods.
   */
  @Override
  ...
  /**
   * Returns the next pseudo-random, uniformly distributed {@code int} value from this random number
   * generator's sequence.
   *
   * <p>This implementation uses {@link #nextLong()} internally.
   */
  @Override
  public int nextInt() {
    return (int) nextLong();
  ...
  /**
   * Returns a pseudo-random, uniformly distributed {@code int} value between 0 (inclusive) and the
   * specified value (exclusive), drawn from this random number generator's sequence.
   *
   * <p>This implementation uses {@link #nextLong()} internally.
   *
   * @param n the positive bound on the random number to be returned.
   * @return the next pseudo-random {@code int} value between {@code 0} (inclusive) and {@code n}
   *     (exclusive).
   */
  @Override
  ...
  /**
   * Returns a pseudo-random, uniformly distributed {@code long} value between 0 (inclusive) and the
   * specified value (exclusive), drawn from this random number generator's sequence. The algorithm
   * used to generate the value guarantees that the result is uniform, provided that the sequence of
   * 64-bit values produced by this generator is.
   *
   * <p>This implementation uses {@link #nextLong()} internally.
   *
   * @param n the positive bound on the random number to be returned.
   * @return the next pseudo-random {@code long} value between {@code 0} (inclusive) and {@code n}
   *     (exclusive).
   */
  ...
  /**
   * Returns a pseudo-random, uniformly distributed {@code double} value between 0.0 and 1.0from
  ...
  /**
   * Returns a pseudo-random, uniformly distributed {@code float} value between 0.0 and 1.0 from
   * this random number generator's sequence.
   *
   * <p>This implementation uses {@link #nextLong()} internally.
   */
  ...
  /**
   * Returns a pseudo-random, uniformly distributed {@code boolean } value from this random number
   * generator's sequence.
   *
   * <p>This implementation uses {@link #nextLong()} internally.
   */
   ...
   *
   * <p>The given seed is passed twice through an hash function. This way, if the user passes a
   * small value we avoid the short irregular transient associated with states having a very small
   * number of bits set.
   *
  ...
  /**
   * Returns a Integer within range. (Not original code from class).
   *
   * @param minimum The minimum value to return.
   * @param maximum The maximum value to return.
   * @return Returns a value between the minimum and maximum values given.
   */
  ...
  /**
   * Returns a Float within range. (Not original code from class).
   *
   * @param minimum The minimum value to return.
   * @param maximum The maximum value to return.
   * @return Returns a value between the minimum and maximum values given.
  ...
  /**
   * Returns a Double within range. (Not original code from class).
   *
   * @param minimum The minimum value to return.
   * @param maximum The maximum value to return.
   * @return Returns a value between the minimum and maximum values given.
  ...
  /**
   * Returns a Long within range. (Not original code from class).
   *
   * @param minimum The minimum value to return.
   * @param maximum The maximum value to return.
   * @return Returns a value between the minimum and maximum values given.
  ...
  public long nextLong(long minimum, long maximum) {
    try {
      return nextLong(maximum - minimum) + minimum;
    } catch (Exception e) {
      return minimum;
    }
  }
