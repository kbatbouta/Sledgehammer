                ...
                if (c == '<') {
                    if (index + 4 <= text.length() - 1) {
                        ...
                        if ((c1 == 'R' || c1 == 'r') && (c2 == 'G' || c2 == 'g') && (c3 == 'B' || c3 == 'b')
                            ...
                            inCode = true;
                            if (cn1 == ' ') {
                                stripped = new StringBuilder(stripped.toString().substring(0, stripped.length() - 1));
                            }
                        } else if ((c1 == 'L' || c1 == 'l') && (c2 == 'I' || c2 == 'i') && (c3 == 'N' || c3 == 'n')
                                && (c4 == 'E' || c4 == 'e')) {
                            inCode = true;
                            if (cn1 == ' ') {
                                stripped = new StringBuilder(stripped.toString().substring(0, stripped.length() - 1) + (newLine ? "\n" : ""));
                            }
                        }
                    }
                } else {
