...
public class PermissionsListener implements PermissionListener {
   ...
   * Main constructor.
   *
   * @param module The ModulePermissions using the listener.
   */
  ...
  public boolean hasPermission(Player player, String node) {
    ...
    granted =
        wildcard
            ? permissionGroupDefault.hasAnyPermission(node)
            : permissionGroupDefault.hasPermission(node);
    ...
    if (permissionUser != null) {
      granted =
          wildcard ? permissionUser.hasAnyPermission(node) : permissionUser.hasPermission(node);
    }
    return granted;
  }
   ...
   * (Private Method)
   *
   * <p>Sets the ModulePermissions instance using the listener.
   *
   * @param module The ModulePermissions instance to set.
   */
