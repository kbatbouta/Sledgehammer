...
public class ModuleFactions extends MongoModule {
   ...
   * (Private Method)
   *
   * <p>Loads Database Objects and constructs Lua Objects.
   */
   ...
   * (Private Method)
   *
   * <p>Constructs Lua wrapper Objects to represent the data.
   */
   ...
   * (Private Method)
   *
   * <p>Loads MongoFaction Objects from the database.
   */
   ...
   * (Private Method)
   *
   * <p>Loads MongoFactionMember Objects from the database.
   */
  private void loadMongoFactionMembers() {
    ...
    while (cursor.hasNext()) {
      ...
      MongoFactionMember mongoFactionMember =
          new MongoFactionMember(collectionFactionMembers, cursor.next());
   ...
   * (Private Method)
   *
   * <p>Loads MongoFactionInvite Objects from the database.
   */
  private void loadMongoFactionInvites() {
    ...
    while (cursor.hasNext()) {
      // Create an object for each entry.
      MongoFactionInvite mongoFactionInvite =
          new MongoFactionInvite(collectionFactionInvites, cursor.next());
   ...
   */
  public Response commandCreateFaction(
      Player commander, String factionName, String tag, String password) {
    if (commander == null) {
    ...
    try {
      ...
      response.log(
          LogType.INFO, commander.getUsername() + " created faction \"" + factionName + "\".");
    } catch (Exception e) {
      stackTrace(e);
  ...
  public Response commandInviteToFaction(Player commander, String usernameInvited) {
    ...
    if (factionOwner == null) {
      throw new IllegalStateException(
          "FactionMember exists for player ID: \""
    ...
    if (memberInvited != null) {
      ...
      if (factionInvited.isOwner(playerInvited)) {
        response.set(
            Result.FAILURE, lang.getString("command_faction_invite_owner", language, fieldPlayer));
        return response;
      }
    }
    ...
    if (factionInvite != null && !factionInvite.isExpired(timeToLiveInvites)) {
      response.set(
          Result.FAILURE, lang.getString("command_faction_invite_exists", language, fieldPlayer));
      return response;
    }
    try {
      // Process the invite.
      createFactionInvite(factionOwner, commander.getUniqueId(), playerInvited.getUniqueId());
      playerInvited.sendChatMessage(
          "You have been invited to join the faction " + factionOwner.getFactionName() + ".");
      playerInvited.sendChatMessage("Type \'/faction accept \"faction\"\' to accept.");
      playerInvited.sendChatMessage(
          "To reject an invitation, type \'/faction reject " + "\"faction\'.");
      response.set(
          Result.SUCCESS, lang.getString("command_faction_invite_success", language, fieldPlayer));
      // TODO: Log message.
    } catch (Exception e) {
      stackTrace(e);
  ...
  public Response commandJoinFaction(Player commander, String factionName, String password) {
    ...
    try {
      ...
      response.set(
          Result.SUCCESS, lang.getString("command_faction_join_success", language, fieldFaction));
      // TODO: Log message.
    } catch (Exception e) {
      stackTrace(e);
  ...
  /**
   * Rejects and deletes FactionInvite invites for the Player. If null is passed on the Faction
   * argument, then all invites that exist (if any), will be rejects and deleted.
   *
   * @param commander The Player being affected.
   * @param factionName The name of the Faction being specified. If "all" is passed, all
   *     FactionInvites will be processed.
   * @return Returns a Response that details the result of the action.
   */
  public Response commandRejectInvites(Player commander, String factionName) {
    ...
    if (faction != null) {
      ...
      if (factionInvite == null) {
        response.set(
            Result.FAILURE, lang.getString("faction_invite_not_found", language, fieldFaction));
        return response;
      }
      try {
        ...
        response.set(
            Result.SUCCESS,
            lang.getString("command_faction_reject_success", language, fieldFaction));
        // TODO: Log message.
      } catch (Exception e) {
        stackTrace(e);
    ...
    // If the faction is not specified, we grab every faction invite for the player.
      ...
      try {
        ...
        response.set(
            Result.SUCCESS, lang.getString("command_faction_reject_success_all", language));
        // TODO: Log message;
      } catch (Exception e) {
        stackTrace(e);
        response.set(
            Result.FAILURE, lang.getString("command_faction_reject_failure_all", language));
      }
      return response;
    }
  }
  ...
  public Response commandKickFromFaction(Player commander, String usernameKicked, String reason) {
    ...
    try {
      ...
      response.set(
          Result.SUCCESS, lang.getString("command_faction_kick_success", language, fieldPlayer));
      // TODO: Log message.
    } catch (Exception e) {
      stackTrace(e);
   ...
   *
   * @param commander The Player. Will return as a failure if not the owner of a Faction.
   ...
   * @return Returns a Response that details the result of the action.
   */
  public Response commandSetFactionPassword(
      Player commander, String passwordOriginal, String passwordNew) {
    if (commander == null) {
      throw new IllegalArgumentException("Player given is null!");
    }
    Response response = new Response();
    ...
    try {
      ...
      // Return the success message.
      response.set(
          Result.SUCCESS, lang.getString("command_faction_set_password_success", language));
      // TODO: Log message.
    } catch (Exception e) {
      stackTrace(e);
      response.set(
          Result.FAILURE, lang.getString("command_faction_set_password_failure", language));
    }
    return response;
  }
  ...
  public Response commandSetFactionTag(Player commander, String tagNew) {
    ...
    try {
      ...
      // Return the success message.
      response.set(
          Result.SUCCESS, lang.getString("command_faction_set_tag_success", language, fieldTag));
      // TODO: Log message.
    } catch (Exception e) {
      stackTrace(e);
   ...
   * @return Returns a Response result. If all validations pass, Result.SUCCESS is passed.
   */
  public Response commandSetFactionName(Player commander, String nameNew) {
    ...
    try {
      ...
      response.set(
          Result.SUCCESS,
          lang.getString("command_faction_set_name_success", language, fieldFaction));
      // TODO: Log message.
    } catch (Exception e) {
      stackTrace(e);
  ...
  public Response commandSetFactionColor(Player commander, String colorNew) {
    ...
    if (faction.getFactionColor().equalsIgnoreCase(colorCode)) {
      response.set(
          Result.FAILURE, lang.getString("faction_color_already_used", language, fieldColor));
      return response;
    }
    try {
      ...
      response.set(
          Result.SUCCESS,
          lang.getString("command_faction_set_color_success", language, fieldColor));
      // TODO: Log message.
    } catch (Exception e) {
      stackTrace(e);
  ...
  /**
   * @param commander Will return as a failure if not the owner of a Faction.
   ...
   * @return Returns a Response that is never null. If the validation is a success,
   *     response.getResult() should return Result.SUCCESS.
   */
  public Response validateFactionTag(String tag, Language language) {
    ...
    if (lengthTag < charsMin || lengthTag > charsMax) {
      ...
      response.set(
          Result.FAILURE,
          lang.getString(
              "faction_tag_rules", language, fieldMinimumCharacters, fieldMaximumCharacters));
      return response;
    }
  ...
  public Response validateFactionName(String name, Language language) {
    ...
    if (lengthTag < charsMin || lengthTag > charsMax) {
      ...
      response.set(
          Result.FAILURE,
          lang.getString(
              "faction_name_rules", language, fieldMinimumCharacters, fieldMaximumCharacters));
      return response;
    }
    // Check to see if the tag is already being used by another Faction.
   ...
   * @return Returns a Response based on the results of the tests. If all tests pass, Result.SUCCESS
  ...
  public Response validatePlayerFactionCreate(Player player) {
    ...
    if (factionMember != null) {
      ...
      if (faction.isOwner(factionMember)) {
        response.set(
            Result.FAILURE,
            lang.getString("command_faction_create_already_own_faction", language, fieldFaction));
        return response;
      }
      ...
      // a new faction.
        ...
        response.set(
            Result.FAILURE, lang.getString("command_faction_create_already_in_faction", language));
      }
    }
    return response;
  }
  ...
  public Response acceptInvite(FactionInvite factionInvite, Language language) {
    ...
    if (faction == null) {
      ...
      deleteInvite(factionInvite);
      EntryField fieldFactionId =
          new EntryField("faction", "(UUID: " + factionInvite.getUniqueId().toString() + ")");
   ...
   * (Private Method)
   *
   * <p>Resets the maps and fields for the module.
   */
  private void reset() {
  ...
  /**
   * Creates a Faction with given parameters, along with a new FactionMember, if one for the owner
   * does not exist.
   *
   * @param factionName The String name of the Faction.
   * @param tag The String tag of the Faction.
   * @param password The administrator String password of the Faction.
   * @param ownerId The Unique ID of the Player that is set to as the owner of the Faction.
  ...
  public Faction createFaction(String factionName, String tag, String password, UUID ownerId) {
    ...
    if (mongoFactionMember == null) {
      mongoFactionMember =
          new MongoFactionMember(collectionFactionMembers, ownerId, faction.getUniqueId());
  ...
  /**
   * Removes a Faction from the database, and removes FactionMembers from the Faction.
   *
  ...
  /**
   * Creates a FactionMember container for the given Player, and adds this to the Faction provided.
   *
  ...
  public FactionMember createFactionMember(UUID playerId, Faction faction) {
    ...
    MongoFactionMember mongoFactionMember =
        new MongoFactionMember(collectionFactionMembers, playerId, faction.getUniqueId());
    mapMongoFactionMembers.put(mongoFactionMember.getPlayerId(), mongoFactionMember);
  ...
  /**
   * @param tag The String tag of the Faction.
   * @return Returns a Faction if one exists using the tag provided. Returns null if no Faction uses
   *     the tag provided.
   */
  ...
  /**
   * @param playerId The Unique ID of the Player.
   * @return Returns a FactionMember. Returns null if the Player is not a member of a Faction.
   */
   ...
   * @return Returns a FactionMember with a given Player. Returns null if the Player is not a member
   *     of a Faction.
   */
   ...
   * @return Returns the Faction. If there is none, null is returned.
   */
  ...
  /**
   * @param tag The String tag of the Faction.
   * @return Returns true if a Faction is currently using the provided tag. (The tag is forced
   *     upper-case on the check. All Faction tags are upper-case).
   */
  ...
  /**
   * @param playerId The Unique ID of the Player.
   * @return A LinkedList of FactionInvites for a Player. If the Player has no invites, the list
   *     will return empty.
   */
   ...
   * @return Returns a FactionInvite if a invite exists for the Player from the Faction. Returns
   *     null if a invite does not exist.
   */
  ...
  public ChatChannel createChatChannel(Faction faction) {
    return createChatChannel(
        "Faction_" + faction.getFactionName(),
        "A Faction chat channel.",
        "sledgehammer.faction.chat",
        true,
        false,
        true,
        true,
   ...
   *
   * @param faction The Faction that the ChatChannel being unregistered is being removed.
   * @return Returns the ChatChannel associated with the Faction being removed.
   */
  ...
  public void createFactionInvite(Faction factionOwner, UUID playerIdOwner, UUID playerIdInvited) {
    ...
    MongoFactionInvite mongoFactionInvite =
        new MongoFactionInvite(
            collectionFactionInvites, playerIdOwner, playerIdInvited, factionOwner.getUniqueId());
