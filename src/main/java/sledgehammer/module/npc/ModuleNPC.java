...
/**
 * Module to handle NPC data and operations for the Core Plug-in of Sledgehammer.
 *
...
public class ModuleNPC extends Module {
  ...
  /** The Map of native IsoGameCharacter Objects, identified by the Sledgehammer NPC wrapper. */
   ...
   * @return Returns a NPC instance with the String name, spawned at the given Float coordinates.
   */
