...
public class ModuleCore extends Module {
  ...
  private void loadPeriodicMessages() {
    ...
    if (cursor.hasNext()) {
      MongoPeriodicMessage message =
          new MongoPeriodicMessage(collectionPeriodicMessages, cursor.next());
  ...
  /**
   * Adds a PeriodicMessage to the core, which will be displayed periodically to all players who
