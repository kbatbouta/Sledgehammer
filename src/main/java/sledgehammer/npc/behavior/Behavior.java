...
/**
 * Class to handle NPCs with a passive, long-term behavior pattern. This class provides utilities
 * and executes Actions for the NPC to act on.
 *
 * @author Jab
 */
public abstract class Behavior extends Printable {
   ...
   * @return Returns a List of IsoWorldInventoryObjects around the NPC on the ground.
   */
  ...
  /**
   * @return Returns the default IsoMovingObject target for the NPC to follow. (Note: This is the
   *     passive, or secondary target to follow)
   */
   ...
   *
   * <p>(Note: This is a passive, or secondary target to follow)
   *
   ...
   *
   * <p>Sets the location for a NPC to attempt traveling towards.
   *
  ...
  /**
   * @return Returns the IsoWorldInventoryObject set for the NPC to attempt picking up. If nothing
   *     is set to be picked up, null is returned.
   */
  ...
  /**
   * @return Returns the IsoGameCharacter target for the NPC to attack. if no target is set, null is
   *     returned.
   */
   ...
   * @return Returns the Float distance between a NPC and the given IsoObject.
   */
