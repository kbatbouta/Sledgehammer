 ...
 *
 * <p>TODO: Removed unused flags from this PlayerEvent.
 *
 * @author Jab
 */
public class ChatEvent extends PlayerEvent {
   ...
   * @param input The String raw input from the Player.
   */
   ...
   *
   * @param input The String input to set.
   */
   ...
   *
   * @param header The String header to set.
   */
   ...
   *
   * @param color The String encoded color to set.
   */
   ...
   *
   * @param chatType The Byte type flag to set.
   */
   ...
   *
   * @param listMutedUsers The List of String user-names to set.
   */
