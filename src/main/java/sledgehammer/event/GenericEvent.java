...
/**
 * This is an Event sub-type that allows Modules to author commands, and send them to other module
...
public class GenericEvent extends Event {
  ...
  /**
   * The type. This is used to clarify in a Module-like way what the Event is, or what group of
   * Event the GenericEvent is.
   */
   ...
   * @param context The String context of the GenericEvent. This Usually carries data, or is a
   *     String.
   */
  ...
  /**
   * @return Returns the type of this GenericEvent. This is used to clarify in a module-like way
   *     what the event is, or what group of events this is.
   */
   ...
   * (Private Method)
   *
   * <p>Sets the String type of GenericEvent.
   *
  ...
  /**
   * @return Returns the context of this GenericEvent. This usually carries data, or a simple
   *     string.
   */
   ...
   * (Private Method)
   *
   * <p>Sets the String context of the GenericEvent.
   *
   ...
   * (Private Method)
   *
   * <p>Sets the Module that authored the GenericEvent.
   *
