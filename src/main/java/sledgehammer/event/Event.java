...
public abstract class Event {
	...
	/** Flag for whether or not to ignore the Core plug-in's <EventListener>'s. */
	...
	/**
	 * @return Returns true if the Core plug-in's <EventListener>'s are ignored by
	 *         this <Event>.
	 */
	...
	/**
	 * Sets the <Event> to ignore the Core plug-in's <EventListener>'s.
	 * 
	 * @param flag
	 *            The flag to set.
	 */
