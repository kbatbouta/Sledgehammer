...
public class PermissionObject {
	...
	public PermissionObject(String name, int id) {
		...
		if(ZIRC.DEBUG) System.out.println("PermissionObject: " + "CREATE: ID: " + getID() + " NAME: " + getName());
	}
	...
	public void setPermission(String context, boolean allow) {
		...
		if(ZIRC.DEBUG) System.out.println("PermissionObject: " + getName() + ": Adding permission \"" + context + "\": " + allow + ".");
